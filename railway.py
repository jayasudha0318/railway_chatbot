...
u1 = user(4018,'ankitha','kolkata','6789044444','ankitha')
...
def setrem():
    ...
    if(phno>=0000000000 and phno<=9999999999):
        print("the remainder had sent to",phno)
...
print("-------------------------------------------------------Hii... This is RAILWAY CHATTY!!-------------------------------------------------")
...
def menu():
	...
	print("1.create new account (new user)")
	print("2.login")
	print("3.Ticket Booking")
	print("4.Ticket Cancellation")
	print("5.Check PNR ")
	print("6.Check running status")
	print("7.Check previous bookings")
	print("8.order food online")
	print("9.job vacancy,exam dates,results")
	print("10.railway stations near by")
	print("11.set remainder")
	print("12.exit")
	
	func = { 3 : book_ticket, 4 : cancel_ticket, 5 : check_pnr, 6 : check_seat_availabilty, 1 : create_new_acc, 7 : check_prev_bookings, 2 : login, 12 : end, 8 : order_food, 9 : job_vacancy, 10 : stations_nearby, 11 : setrem }
